...
| Guide | What it covers |
|---|---|
| [⚖️ Comparison](comparison.md) | Laravel tooling across editors, plus the architecture, LSP capabilities, and per-feature depth behind the README's Community Edition vs. official-extension decision table |
